...
ADD https://downloads01-he-fi.apache.org/tomcat/tomcat-11/v11.0.25/bin/apache-tomcat-11.0.25-deployer.tar.gz .

RUN tar -xzvf jdk-17.0.12_linux-x64_bin.tar.gz
RUN rm -rf jdk-17.0.12_linux-x64_bin.tar.gz
RUN tar -xzvf apache-tomcat-11.0.25-deployer.tar.gz
RUN rm -rf apache-tomcat-11.0.25-deployer.tar.gz
